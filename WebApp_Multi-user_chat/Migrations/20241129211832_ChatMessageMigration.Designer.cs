...
namespace WebApp_Multi_user_chat.Migrations
{
    ...
    [Migration("20241129211832_ChatMessageMigration")]
            ...
            modelBuilder.Entity("WebApp_Multi_user_chat.Entities.Notification", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RoomName = "General",
                            TimeStamp = new DateTime(2024, 11, 30, 0, 18, 30, 901, DateTimeKind.Local).AddTicks(8973),
                            UserId = "user1"
                        },
                        new
                        {
                            ...
                            NotificationType = "Join",
                            RoomName = "Sports",
                            TimeStamp = new DateTime(2024, 11, 30, 0, 18, 30, 901, DateTimeKind.Local).AddTicks(8978),
                            UserId = "user2"
                        });
                });
